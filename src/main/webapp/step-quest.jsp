...
<div class="container text-center mt-5">
  <button type="button" class="btn btn-outline-info" data-bs-toggle="modal" data-bs-target="#myModal">Статистика</button>
</div>
...
<div class="container text-center mt-5">
  <div class="row">
      <c:forEach var="answer" items="${requestScope.question.answers}">
        <div class="col-6">
          <button type="button" class="btn col-8 btn-primary" onclick="window.location='/quest?questionId=${answer.nextQuestionId}'" style="">
              ${answer.text}
          </button>
        </div>
      </c:forEach>
